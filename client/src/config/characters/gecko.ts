...
/**
 * Gecko Character Configuration
 * Lizard-like reptile with wall-climbing abilities and stealth behaviors
 */
export const geckoConfig: CharacterConfig = {
  ...
  behaviors: {
    isPlayer: true,
    isNPC: true,
    movementSpeed: 0.9,      // Careful, deliberate movements
    jumpHeight: 1.0,         // Modest jumps
    canSwim: true,
    canFly: false,
    aiBehaviors: [
